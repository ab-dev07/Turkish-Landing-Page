...
const HeroSection = () => {
  ...
  const handleNext = () => {
    setActiveIndex((prevIndex) => (prevIndex === 0 ? 1 : 0)); // Toggle images
  };

  const handlePrev = () => {
    setActiveIndex((prevIndex) => (prevIndex === 1 ? 0 : 1)); // Toggle images
  };
  ...
  return (
    <div className="relative w-full h-[105vh] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4 -mt-16">
        ...
        <h2 className="text-5xl md:text-7xl font-bold mb-2 tracking-wide">ANNIVERSARY BETWEEN</h2>
        <h2 className="text-5xl md:text-7xl font-bold mb-2 tracking-wide">TURKEY & LATIN WORLD</h2>
